...
class ShopifyController extends Controller
{
    ...
    {
        $shopifies = Auth::user()->shopifies()->latest()->get();
        return view('freelancer.shopify.index',compact('shopifies'));
    }
    ...
    {
        return view('freelancer.shopify.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $shopify->is_approved = false;
        $shopify->save();

        Toastr::success('Product Successfully Saved','Success');
        return redirect()->route('freelancer.shopify.index');
    }

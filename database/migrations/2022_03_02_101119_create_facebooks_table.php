...
class CreateFacebooksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('facebooks', function (Blueprint $table) {
            ...
            $table->longText('body');
            $table->string('page_logo')->nullable()->default('1.jpg');
            $table->string('gif_one')->nullable()->default('1.gif');
            $table->string('gif_two')->nullable()->default('2.gif');
            $table->string('gif_three')->nullable()->default('3.gif');
            $table->string('thumbnail')->nullable()->default('1.jpg');
            $table->string('video')->nullable()->default('1.mp4');

...
<a href="{{ route('admin.privacy.index') }}" class="btn btn-danger">Back</a>
</div>
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
            <h5 class="card-header">Add New Privacy</h5>
            <div class="card-body">

                <form method="POST" action="{{ route('admin.privacy.store') }}" enctype="multipart/form-data" id="formValidationExamples" class="row g-3">
                @csrf

                <div class="col-12 form-group" style="margin-top: 0px !important;">
                    <label class="form-check-label mb-2" for="postdescription">Privacy Description</label>

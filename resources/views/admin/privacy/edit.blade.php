    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.privacy.update',$privacy->id) }}" enctype="multipart/form-data" id="formValidationExamples" class="row g-3">
                @csrf
                @method('PUT')
                ...
                <div class="col-12 form-group">
                    ...
                    <textarea class="form-control" name="body" id="summernote">{{ $privacy->body }}</textarea>
                    <script>

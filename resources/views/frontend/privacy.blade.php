...
@section('title','Privacy Policy Notice')
@section('facebook_meta')
    ...
    <meta property="og:title" content="{{ config('app.name', 'eButify.com') }} - Privacy Policy Notice" />
    ...
    <meta name="twitter:title" content="{{ config('app.name', 'eButify.com') }} - Privacy Policy Notice">
...
<main class="main">   
    ...
    <section class="home" id="home">
        ...
        <div class="privacy_banner_container container grid">
            <div class="privacy_banner_title">Privacy Policy</div>
        </div>
    </section>

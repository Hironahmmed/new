...
<head>
    ...
    <title>eButify.com - 500 error Internal Server Error!</title>
...
<body>
    ...
    <div class="terminal">
        <code><h1>ERROR<span class="errorcode"> 500</span><sub style="font-size: 1.5rem;">  Internal Server Error!</sub></h1></code>

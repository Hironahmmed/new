...
<head>
    ...
    <title>eButify.com - 401 error Page Unauthorised!</title>
...
<body>
    ...
    <div class="terminal">
        <code><h1>ERROR<span class="errorcode"> 401</span><sub style="font-size: 1.5rem;"> Page Unauthorised!</sub></h1></code>

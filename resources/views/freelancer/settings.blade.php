        ...
        <div class="nav-align-top mb-4">
            ...
            <!-- Update Profile Info -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <input class="form-control" type="email" id="email" name="email" value="{{ Auth::user()->email }}" placeholder="Enter your valid email" disabled/>
                            </div>
                            <div class="mb-3 col-md-12">
                ...
                <h5 class="card-header pb-0 !important;">Change Password</h5>
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="{{ route('freelancer.password.update') }}">
                        @csrf
                        @method('PUT')
                        <div class="row">

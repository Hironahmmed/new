...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <a href="{{ route('freelancer.amazon.index') }}" class="btn btn-danger">Back</a>
    </div>
    <div class="row">
        <!-- FormValidation -->
        <div class="col-12">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('freelancer.amazon.store') }}" id="formValidationExamples" class="row g-3">
                @csrf
                    <div class="col-md-4">

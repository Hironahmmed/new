                  ...
                  <div class="head-label text-center"><h5 class="card-title mb-0">All Facebook Ad <span class="badge rounded-pill  bg-label-success">{{ $facebooks->count() }}</span></h5></div>
                      <div class="dt-action-buttons text-end pt-3 pt-md-0">
                          <div class="dt-buttons"> 
                              <a href="{{ route('freelancer.facebook.create') }}" class="dt-button create-new btn btn-primary"><span><i class="bx bx-plus me-sm-2"></i> <span class="d-none d-sm-inline-block">Add New Record</span></span></a>
                          </div>
                    </div>
                </div>
                <table class="datatables-basic table table-bordered dataTable no-footer dtr-column collapsed" style="width: 1031px;">
                  ...
                  <tbody>
                      ...
                      <tr class="odd">
                          ...
                          <td>
                              <a href="{{ route('freelancer.facebook.show', $facebook->id )}}" class="btn mr-2 btn-sm btn-icon btn-label-primary"><i class="bx bxs-show"></i></a>
                          </td>
                        </tr>
                        @endforeach
                  </tbody>

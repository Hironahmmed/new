...
@section('title','Create Facebook Ads')
@section('content')
@push('css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-12">
        ...
        <div class="card-body">
            <form class="form-repeater" action="{{ route('freelancer.facebook.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                <div data-repeater-list="group-a">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="adlink" name="ad_link" class="form-control"/>
                        </div>

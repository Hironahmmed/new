<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <div class="app-brand demo ">
        <a href="{{ route('freelancer.dashboard') }}" class="app-brand-link">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboards -->
        <li class="menu-item {{ Request::is('freelancer/dashboard') ? 'active' : ''}}">
            <a href="{{ route('freelancer.dashboard') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('freelancer/ads/tiktok*') ? 'active' : ''}}">
            <a href="{{ route('freelancer.tiktok.index') }}" class="menu-link">
                <i class="menu-icon text-danger fab fa-tiktok"></i>
                <div data-i18n="TikTok Ad"> TikTok Ad</div>
            </a>
        </li>
        <li class="menu-item {{ Request::is('freelancer/ads/facebook*') ? 'active' : ''}}">
            <a href="{{ route('freelancer.facebook.index') }}" class="menu-link">
                <i class="menu-icon text-primary fab fa-facebook-square"></i>
        ...
        <li class="menu-item {{ Request::is('freelancer/explore/shopify*') ? 'active' : ''}}">
            <a href="{{ route('freelancer.shopify.index') }}" class="menu-link">
                <i class="menu-icon text-success fab fa-shopify"></i>
                <div data-i18n="Shopify Explore">Shopify Explore</div>
            </a>
        </li>

        <li class="menu-item {{ Request::is('freelancer/explore/aliexpress*') ? 'active' : ''}}">
            <a href="{{ route('freelancer.aliexpress.index') }}" class="menu-link">
                <i class="menu-icon text-danger fas fa-shopping-bag"></i>
                <div data-i18n="Aliexpress Explore">Aliexpress Explore</div>
            </a>
        </li>

        <li class="menu-item {{ Request::is('freelancer/explore/amazon*') ? 'active' : ''}}">
            <a href="{{ route('freelancer.amazon.index') }}" class="menu-link">
                <i class="menu-icon text-warning fab fa-amazon"></i> 
        ...
        <li class="menu-item {{ Request::is('freelancer/settings') ? 'active' : ''}}">
            <a href="{{ route('freelancer.settings') }}" class="menu-link">
                <i class="menu-icon fas fa-user-shield"></i>
                <div data-i18n="My Settings">My Settings</div>
            </a>
        </li>

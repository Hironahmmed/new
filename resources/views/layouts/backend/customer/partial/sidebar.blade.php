<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Favorite -->
        <li class="menu-item {{ Request::is('favorite*') ? 'active open' : ''}}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon {{ Request::is('favorite*') ? 'text-success' : ''}} fab fa-gratipay"></i>
                <div data-i18n="Saved Ads">Saved Ads</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('favorite/facebook') ? 'active' : ''}}">
                    <a href="{{ route('customer.facebook.favorite.index') }}" class="menu-link">
                        <div data-i18n="Facebook Ads">Facebook Ads</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('favorite/tiktok') ? 'active' : ''}}">
                    <a href="{{ route('customer.tiktok.favorite.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('facebook*') ? 'active' : ''}}">
            <a href="{{ route('customer.facebook') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('tiktok*') ? 'active' : ''}}">
            <a href="{{ route('customer.tiktok') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('shopify') ? 'active' : ''}}">
            <a href="{{ route('customer.shopify') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('aliexpress') ? 'active' : ''}}">
            <a href="{{ route('customer.aliexpress') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('amazon') ? 'active' : ''}}">
            <a href="{{ route('customer.amazon') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('tutorial') ? 'active' : ''}}">
            <a href="{{ route('customer.tutorial') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('contact') ? 'active' : ''}}">
            <a href="{{ route('customer.contact') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('my.faq') ? 'active' : ''}}">
            <a href="{{ route('customer.faq') }}" class="menu-link">

  ...
  <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar  ">
        <div class="layout-container">
            ...
            <!-- Sidebar Menu -->
            @include('layouts.backend.customer.demo_partial.sidebar')
            <!-- / Sidebar Menu -->
            ...
            <div class="layout-page">
                ...
                <!-- Navbar -->
                @include('layouts.backend.customer.demo_partial.header')
                <!-- / Navbar -->
                ...
                <div class="content-wrapper">
                    ...
                    <!-- Footer -->
                    @include('layouts.backend.customer.demo_partial.footer')
                    <!-- / Footer -->

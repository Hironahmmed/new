<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item {{ Request::is('author/dashboard') ? 'active' : ''}}">
        ...
        <li class="menu-item {{ Request::is('author/blog*') ? 'active' : ''}}">
            <a href="{{ route('author.post.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('author/settings') ? 'active' : ''}}">
            <a href="{{ route('author.settings') }}" class="menu-link">

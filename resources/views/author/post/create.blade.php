    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('author.post.store') }}" enctype="multipart/form-data" id="formValidationExamples" class="row g-3">
                @csrf
                <div class="col-md-6">
                    <label class="form-label" for="formValidationName">Post Title</label>
                    <input type="text" id="title" class="form-control" placeholder="Post Title" name="title" />
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-check custom mb-2">
                                <input type="checkbox" id="publish" name="status" class="form-check-input filled-in" value="0"/>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check custom mb-2">
                                <input type="checkbox" id="featured" name="featured" class="form-check-input filled-in" value="0"/>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check custom mb-2">
                                <input type="checkbox" id="popular" name="popular" class="form-check-input filled-in" value="0"/>

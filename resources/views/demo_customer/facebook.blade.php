...
@section('title','Demo Facebook Product Research')
@push('css')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-0.5">
                            <div class="card-body" style="padding-left: 0rem !important;">
                                <button data-bs-toggle="modal" data-bs-target="#addNewCCModal" class="btn btn-success">Get All Result</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 col-xl-4 mb-3">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="product_text">
                            <span class="info-left">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="card-info">
                                        <p class="card-title mb-0 me-2"> <a href="" data-bs-toggle="modal" data-bs-target="#addNewCCModal"> {{ $loadad->page_name }}</a></p>
                                        <div>
                                            <small><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addNewCCModal">{{ $loadad->shopify_website }}</a> </small>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                            ...
                            <span>
                                <a href="javascript:void(0);" controlsdata-play="hover" class="btn btn-icon rounded-pill btn-outline-success" data-bs-toggle="modal" data-bs-target="#addNewCCModal"><i class="fab fa-facebook-f"></i></a>
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="product_text">
                            <span class="info-left">
                                <div class="d-flex justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                    <div class="card-info">
                                        <a href="{{ route('demo.facebook.details',$loadad->slug) }}" class="text-black"><small class="card-title mb-0 me-2">{{ str_limit($loadad->title,'28') }}</small></a>
                                        <div>
                            ...
                            <span><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#addNewCCModal" class="btn btn-outline-primary is-light is-rounded">{{ $loadad->action }}</a></span>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('demo.facebook.details',$loadad->slug) }}" data-bs-toggle="modal" data-bs-target="#addNewCCModal" class="btn btn-facebook"><i class="text-white fas fa-heart" style="margin-right: .8rem;"></i>Favorite</a>
                            <a href="{{ route('demo.facebook.details',$loadad->slug) }}" class="btn btn-facebook text-white"><i class="fas fa-info-circle" style="margin-right: .8rem;"></i>Details</a>
                        </div>
                    </div>
                </div>

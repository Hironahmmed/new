...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row">
        ...
        <span class="text-center text-danger">Browse Ads and add to favorite Now<br><a data-bs-toggle="modal" data-bs-target="#addNewCCModal" href="{{ route('register') }}" type="button" class="btn btn-primary mt-3">View Facebook Ad</a></span>
    </div>
</div>
@endsection
